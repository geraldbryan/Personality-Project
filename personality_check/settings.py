"""
Django settings for personality_check project.
...
ROOT_URLCONF = 'personality_check.urls'
...
WSGI_APPLICATION = 'personality_check.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR,"check\static")
